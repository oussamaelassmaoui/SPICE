...
@section('content')
    <form class="row g-3 needs-validation" action="{{ route('SERVICES.update', $SERVICES->id) }}" method="POST"
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('title') is-invalid @enderror" name="title"
                    id="validationCustom10" value="{{ old('title', $SERVICES->title) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <textarea cols="30" rows="5" name="text" class="form-control py-3 @error('text') is-invalid @enderror"
                    id="text" placeholder="Notes" required>{{ old('text', $SERVICES->text) }}</textarea>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <textarea cols="30" name="text2" rows="5" class="form-control py-3 @error('text2') is-invalid @enderror"
                    id="text2" placeholder="Notes" required>{{ old('text2', $SERVICES->text2) }}</textarea>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <textarea cols="30" name="text3" rows="5" class="form-control py-3 @error('text3') is-invalid @enderror"
                    id="summernote" placeholder="Notes" required>{{ old('text3', $SERVICES->text3) }}</textarea>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('FAQ1') is-invalid @enderror" name="FAQ1"
                    id="validationCustom10" value="{{ old('FAQ1', $SERVICES->FAQ1) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('rep1') is-invalid @enderror" name="rep1"
                    id="validationCustom10" value="{{ old('rep1', $SERVICES->rep1) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('FAQ2') is-invalid @enderror" name="FAQ2"
                    id="validationCustom10" value="{{ old('FAQ2', $SERVICES->FAQ2) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('rep2') is-invalid @enderror" name="rep2"
                    id="validationCustom10" value="{{ old('rep2', $SERVICES->rep2) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('FAQ3') is-invalid @enderror" name="FAQ3"
                    id="validationCustom10" value="{{ old('FAQ3', $SERVICES->FAQ3) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('rep3') is-invalid @enderror" name="rep3"
                    id="validationCustom10" value="{{ old('rep3', $SERVICES->rep3) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('FAQ4') is-invalid @enderror" name="FAQ4"
                    id="validationCustom10" value="{{ old('FAQ4', $SERVICES->FAQ4) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('rep4') is-invalid @enderror" name="rep4"
                    id="validationCustom10" value="{{ old('rep4', $SERVICES->rep4) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('FAQ5') is-invalid @enderror" name="FAQ5"
                    id="validationCustom10" value="{{ old('FAQ5', $SERVICES->FAQ5) }}" required>
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('rep5') is-invalid @enderror" name="rep5"
                    id="validationCustom10" value="{{ old('rep5', $SERVICES->rep5) }}" required>
