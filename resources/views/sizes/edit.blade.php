...
@section('content')
    <form class="row g-3 needs-validation" action="{{ route('sizes.update', $size->id) }}" method="POST"
        ...
        <div class="col-md-6">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('name') is-invalid @enderror" name="name"
                    id="validationCustom10" value="{{ old('name', $size->name) }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group mb-4">
                ...
                <div class="form-group position-relative">
                    <input type="number" value="{{ old('price', $size->price) }}" name="price" class="form-control ps-5 text-gray-light h-58"
