...
@section('content')
<form class="row g-3 needs-validation" action="{{ route('Information.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    
    <div class="col-md-12">
        <label for="validationCustom11" class="form-label label">Mobile 1</label>
        <div class="position-relative">
            <input type="text" name="Mobile1" class="form-control h-58 @error('Mobile1') is-invalid @enderror"
                id="validationCustom11" value="{{ old('Mobile1') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="Mobile2" class="form-control h-58 @error('Mobile2') is-invalid @enderror"
                id="validationCustom11" value="{{ old('Mobile2') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="email" name="email1" class="form-control h-58 @error('email1') is-invalid @enderror"
                id="validationCustom11" value="{{ old('email1') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="email" name="email2" class="form-control h-58 @error('email2') is-invalid @enderror"
                id="validationCustom11" value="{{ old('email2') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <textarea cols="30" name="iframe_map" rows="5" class="form-control py-3 @error('iframe_map') is-invalid @enderror"
                id="summernote" placeholder="iframe map" required>{{ old('iframe_map') }}</textarea>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="number" name="OUR_CLIENTS" class="form-control h-58 @error('OUR_CLIENTS') is-invalid @enderror"
                id="validationCustom11" value="{{ old('OUR_CLIENTS') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="number" name="YEARS_EXPERIENCE" class="form-control h-58 @error('YEARS_EXPERIENCE') is-invalid @enderror"
                id="validationCustom11" value="{{ old('YEARS_EXPERIENCE') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="number" name="FRESH_HALAL" class="form-control h-58 @error('FRESH_HALAL') is-invalid @enderror"
                id="validationCustom11" value="{{ old('FRESH_HALAL') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="number" name="TEAM_MEMBER" class="form-control h-58 @error('TEAM_MEMBER') is-invalid @enderror"
                id="validationCustom11" value="{{ old('TEAM_MEMBER') }}" required>
