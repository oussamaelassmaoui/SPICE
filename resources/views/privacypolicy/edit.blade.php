...
@section('content')
    <form class="row g-3 needs-validation" action="{{ route('privacypolicy.update', $privacypolicy->id) }}" method="POST"
        ...
        <div class="col-md-12">
            ...
            <div class="position-relative">
                <textarea cols="30" rows="5" name="content" class="form-control py-3 @error('content') is-invalid @enderror"
                    id="content" placeholder="Notes" required>{{ old('content', $privacypolicy->content) }}</textarea>
