...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">sizes</h3>
                                        ...
                                        <td class="text-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-10">
                                                    <h4 class="fw-semibold fs-14 mb-0">{{$size->name}}</h4>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-10">
                                                    <h4 class="fw-semibold fs-14 mb-0">{{$size->price}} $</h4>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{ route('sizes.destroy', $size) }}" method="POST" class="dropdown-item" >
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom p-4">
            <h5 class="offcanvas-title fs-18 mb-0" id="offcanvasRightLabel">Create sizes</h5>
            ...
            <form  action="{{ route('sizes.store') }}" method="POST">
                @csrf
                    ...
                    <div class="form-group mb-4">
                        <label class="label">sizes Name</label>
                        <input type="text" name="name" class="form-control text-dark @error('name') is-invalid @enderror" placeholder="size Name" value="{{ old('name') }}" required>
                    </div>
                    @error('name')
                    ...
                    @enderror
                        ...
                        <div class="form-group mb-4">
                            <label class="label">size Price</label>
