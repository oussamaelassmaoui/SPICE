...
@section('content')
<form class="row g-3 needs-validation" action="{{ route('chefs.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" class="form-control h-58 @error('name') is-invalid @enderror" name="name"
                id="validationCustom10" value="{{ old('name') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="About_Me" class="form-control h-58 @error('About_Me') is-invalid @enderror"
                id="validationCustom11" value="{{ old('About_Me') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="Mobile" class="form-control h-58 @error('Mobile') is-invalid @enderror"
                id="validationCustom11" value="{{ old('Mobile') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="address" class="form-control h-58 @error('address') is-invalid @enderror"
                id="validationCustom11" value="{{ old('address') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="email" name="email" class="form-control h-58 @error('email') is-invalid @enderror"
                id="validationCustom11" value="{{ old('email') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="PROFESSIONAL_SKILLS" class="form-control h-58 @error('PROFESSIONAL_SKILLS') is-invalid @enderror"
                id="validationCustom11" value="{{ old('PROFESSIONAL_SKILLS') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="number" name="GENERAL_KNOWLEDGE" class="form-control h-58 @error('GENERAL_KNOWLEDGE') is-invalid @enderror"
                id="validationCustom11" value="{{ old('GENERAL_KNOWLEDGE') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="number" name="SIGNATURE_DISHES" class="form-control h-58 @error('SIGNATURE_DISHES') is-invalid @enderror"
                id="validationCustom11" value="{{ old('SIGNATURE_DISHES') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="number" name="CUSTOMER_SATISFIED" class="form-control h-58 @error('CUSTOMER_SATISFIED') is-invalid @enderror"
                id="validationCustom11" value="{{ old('CUSTOMER_SATISFIED') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="number" name="COMMUNICATION_SKILLS" class="form-control h-58 @error('COMMUNICATION_SKILLS') is-invalid @enderror"
                id="validationCustom11" value="{{ old('COMMUNICATION_SKILLS') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <textarea cols="30" name="PERSONAL_INFORMATION" rows="5" class="form-control py-3 @error('PERSONAL_INFORMATION') is-invalid @enderror"
                id="summernote" placeholder="Notes" required>{{ old('PERSONAL_INFORMATION') }}</textarea>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="DISH1" class="form-control h-58 @error('DISH1') is-invalid @enderror"
                id="validationCustom11" value="{{ old('DISH1') }}" required>
        ...
        <div class="form-group">
            ...
            <div class="form-control h-100 text-center position-relative p-4 p-lg-5">
                ...
                <div class="product-upload">
                    ...
                    <input type="file" id="file-upload1" name="photo1" class="@error('photo1') is-invalid @enderror">
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="DISH2" class="form-control h-58 @error('DISH2') is-invalid @enderror"
                id="validationCustom11" value="{{ old('DISH2') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="DISH3" class="form-control h-58 @error('DISH3') is-invalid @enderror"
                id="validationCustom11" value="{{ old('DISH3') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="DISH4" class="form-control h-58 @error('DISH4') is-invalid @enderror"
                id="validationCustom11" value="{{ old('DISH4') }}" required>
