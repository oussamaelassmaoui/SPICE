...
<div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
    <h3 class="mb-sm-0 mb-1 fs-18">terms Condition</h3>
    <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
        ...
        <li>
            <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">terms Condition</span>
        </li>
    </ul>
</div>
        ...
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                <div class="d-sm-flex justify-content-between text-center align-items-center border-bottom pb-20 mb-20">
                    <h4 class="fw-semibold fs-18 mb-sm-0">terms Condition</h4>
                    ...
                    <button class="border-0 btn btn-primary py-2 px-4 text-white fs-14 fw-semibold rounded-3"
                        ...
                        <span class="py-sm-1 d-block">
                            ...
                            <span>Create terms Condition</span>
                        </span>
                    </button>
                </a>
                </div>
                                    ...
                                    <td>
                                        <div class="dropdown action-opt">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('termsCondition.edit', $item->id) }}">
                                                ...
                                                <li>
                                                    ...
                                                    <form action="{{ route('termsCondition.destroy', $item) }}" method="POST" class="dropdown-item" >
                                                        @csrf
                                                        @method('DELETE')
