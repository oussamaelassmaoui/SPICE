...
@section('content')
<form class="row g-3 needs-validation" action="{{ route('Home.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <textarea cols="30" rows="5" name="DELICIOUS_FOOD" class="form-control py-3 @error('DELICIOUS_FOOD') is-invalid @enderror"
                id="DELICIOUS_FOOD" placeholder="Notes" required>{{ old('DELICIOUS_FOOD') }}
            </textarea>
        </div>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="title1" class="form-control h-58 @error('title1') is-invalid @enderror"
                id="validationCustom11" value="{{ old('title1') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <input type="text" name="title2" class="form-control h-58 @error('title2') is-invalid @enderror"
                id="validationCustom11" value="{{ old('title2') }}" required>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <textarea cols="30" rows="5" name="TODAY_SPECIAL_OFFER" class="form-control py-3 @error('TODAY_SPECIAL_OFFER') is-invalid @enderror"
                id="TODAY_SPECIAL_OFFER" placeholder="Notes" required>{{ old('TODAY_SPECIAL_OFFER') }}</textarea>
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <textarea cols="30" rows="5" name="Download" class="form-control py-3 @error('Download') is-invalid @enderror"
                id="Download" placeholder="Notes" required>{{ old('Download') }}</textarea>
