...
<div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
    <h3 class="mb-sm-0 mb-1 fs-18">Settings Home</h3>
    <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
        ...
        <li>
            <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Settings Home</span>
        </li>
    </ul>
 </div>
 <div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <div class="d-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
            <h4 class="fw-semibold fs-18 mb-0">Settings Home</h4>
                                ...
                                <td>
                                    <div class="dropdown action-opt">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="{{ route('Home.edit', $item->id) }}">
                                            ...
                                            <li>
                                                ...
                                                <form action="{{ route('Home.destroy', $item) }}" method="POST"
                                                    class="dropdown-item">
                                                    @csrf
                                                    @method('DELETE')
