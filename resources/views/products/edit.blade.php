...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">edit Product</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">edit Product</span>
            </li>
        </ul>
    </div>
            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h3 class="fs-18 mb-4 border-bottom pb-20 ">edit Product</h3>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="name" class="form-control text-dark ps-5 h-58"
                                            placeholder="Enter Product Tilte" value="{{ old('name', $product->name) }}">
                                        <i
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea class="form-control ps-5 text-dark"  name="slug" placeholder="Some demo slug ... " cols="30" rows="5">{{ old('slug', $product->slug) }}</textarea>
                                        <i
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea id="summernote" class="form-control ps-5 text-dark" name="description" placeholder="Some demo Description ... " cols="30" rows="5">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="number" value="{{ old('price', $product->price) }}" name="price" class="form-control ps-5 text-gray-light h-58"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="number" value="{{ old('old_price', $product->old_price) }}" name="old_price" class="form-control ps-5 text-gray-light h-58" placeholder="Enter old price">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="number" value="{{ old('quantity', $product->quantity) }}" name="quantity" class="form-control ps-5 text-gray-light h-58"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group position-relative mb-3">
                                    ...
                                    <select name="category_id" id="category_id" value="{{ old('category_id', $product->category_id) }}" aria-label="Default select example" class="form-select form-control text-gray-light h-58 ps-5">
                                    ...
                                    <div class="form-control h-100 text-center position-relative p-4 p-lg-5">
                                        <div class="product-upload">
                                            <label for="file-upload" class="file-upload mb-0">
                                                <span
                                                class="d-inline-block wh-110  rounded-10 position-relative ">
                                                    <img src="{{ asset('storage/' .  $product->photo) }}"
                                                    class="d-inline-block wh-110 bg-body-bg rounded-10 position-relative "  alt="project">
                                            ...
                                            <input id="file-upload" value="{{ old('photo', $product->photo) }}"  name="photo" type="file">
                                        </div>
                                    </div>
                                </div>
                            </div>
