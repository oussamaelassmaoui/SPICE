...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">create Reservations</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">create Reservations</span>
            </li>
        </ul>
    </div>
            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h3 class="fs-18 mb-4 border-bottom pb-20 ">create Reservations</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="Phone" placeholder="Phone" class="form-control text-dark ps-5 h-58" >
                                        <i
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        ...
                                        aria-label="Default select example" name="Person">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea class="form-control ps-5 text-dark" name="message" placeholder="Write Message... " cols="30" rows="5"></textarea>
                                        <i
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <button type="submit"
                                        class="btn btn-primary py-3 px-5 fw-semibold text-white">create Reservations</button>
                                </div>
                            </div>
                        </div>
                    </form>
